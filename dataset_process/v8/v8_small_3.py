...
# [关键] 输出文件夹名称
OUTPUT_FOLDER_NAME = 'v8_small_jpg_3' 
...
FREQ_RES_KHZ = 5         
OVERLAP_RATIO = 0.5       
USE_DB_SCALE = False        # === Compare With v8_small_1.py ===

# --- 归一化设置 ---
NORM_TYPE = 'GLOBAL'
GLOBAL_MIN_DB = -100.0      # === Compare With v8_small_2.py ===
GLOBAL_MAX_DB = 10.0        # === Compare With v8_small_2.py ===
