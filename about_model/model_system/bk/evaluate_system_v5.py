...
OUTPUT_DIR = Path(r'E:\huangwenhao\test_results\test_results_v5_1_conf0.2_iou0.6')  # 结果保存路径
...
# [关键参数] 
# 0.001 是计算标准 mAP 的学术设置
# 0.20~0.25 是实际应用和部署的常用设置 (会降低 Recall，但减少误报)
CONF_THRES = 0.20  
# NMS 去重阈值，0.6 是比较稳健的选择
IOU_THRES = 0.60   
...
def main():
    ...
    for bin_file in tqdm(bin_files):
        ...
        # [Pylance 修复] 无论是否可视化，先定义 sample_dir 对象
        ...
        if is_visualizing:
            ...
            # 画 Pred (红色/橙色)
            # 注意：system.predict 已经根据 CONF_THRES 过滤了，所以这里直接画即可
