...
# 引入 V9 系统
from inference_system_v9_sh0 import SignalInferenceSystem, SCHEME
from ultralytics.utils.metrics import ap_per_class, box_iou

# ================= 配置区域 (V9 独立调优) =================
TEST_DIR = Path(r'E:\huangwenhao\processed_datasets\dataset_test')
OUTPUT_DIR = Path(rf'E:\huangwenhao\results\v9\system_v9\test_v9_sh{SCHEME}_1')
